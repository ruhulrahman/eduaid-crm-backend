                  ...
                  <tr>
                    <td class="v-container-padding-padding"
                      ...
                      <div class="v-line-height"
                        ...
                        <p style="font-size: 14px; line-height: 170%;">Seems like you forgot your password for E-Tax Book. If this is true, click below to reset your password.</p>
                      </div>
                        ...
                        <!-- Main Clicking Button -->
                          ...
                          <span class="v-line-height"
                            style="display:block;padding:10px 20px;line-height:120%;"><span
                              style="font-size: 14px; line-height: 16.8px;">Click to Reset Password</span></span>
                        </a>
